...
public class ManageGroupActivity extends BaseThemeActivity {
    ...
    private void initView() {
        ...
        toolbar.setNavigationOnClickListener(v -> {
            if (mSearchAutoComplete.isShown()) {
                try {
                    //如果搜索框中有文字，则会先清空文字
                    mSearchAutoComplete.getText().clear();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Pair<Set<String>, String> objects = getSetAndKey(listType + pkgType);
    ...
    private Pair<Set<String>, String> getSetAndKey() {
        return getSetAndKey(listType + pkgType);
    }

    public static Pair<Set<String>, String> getSetAndKey(int s) {
        Set<String> set;
        String key;
        switch (s) {
            case 11: {
        ...
        return new Pair<>(set, key);
    }

    private ArrayList[] getAll() {
        ArrayList[] lists = new ArrayList[2];
        Set<String> fas = getSetAndKey().first;
    ...
    private ArrayList[] queryAlike(String query) {
        ...
        Set<String> set = getSetAndKey().first;
        for (String name : set) {
        ...
        lists[1] = new SQLOperator(this).queryNickname(query, type, list);
        return lists;
    }
    ...
    private void refreshList(ArrayList[] lists) {
        ...
        listView.setAdapter(new GroupAdapter(pkgType, listType,
                lists, new String[]{title, "好友/群"}, type));
    }
